...
class DebugInfoEntry extends StatelessWidget {
  ...
  List<Widget> buildChildren(
    ...
    for (var child in children) {
      ...
      bool wrapDescription = description.contains("\n") || description.length >= 120;
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    if (description.isNotEmpty && !wrapDescription)
                      Expanded(
                        child: wrapTooltip(
                          Padding(
                            padding: child.showName ? const EdgeInsets.only(left: 4.0) : EdgeInsets.zero,
                            child: Text(description),
                          ),
                          tooltip: !child.showName || name == null ? child.tooltip : null,
                        ),
                      ),
                  ],
                ),
              ...
              if (wrapDescription)
                Padding(
                  padding: child.showName ? const EdgeInsets.only(left: _kChildrenPadding) : EdgeInsets.zero,
                  child: Text(description),
                ),
