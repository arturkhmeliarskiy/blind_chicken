                ...
                children: [
                  ...
                  ConstrainedBox(
                    ...
                    child: Column(
                      children: [
                        SelectableText(
                          widget.entry.response?.statusCode.toString() ?? (widget.entry.error != null ? "ERROR" : "-"),
                          style: Theme.of(context).textTheme.titleMedium?.copyWith(
                                color: widget.entry.error != null ? Colors.red : widget.entry.statusColor,
            ...
            SelectableText.rich(
              TextSpan(
                children: [
                  ...
                  TextSpan(text: widget.entry.response?.time?.toString() ?? "-"),
                ],
              ),
            ),
