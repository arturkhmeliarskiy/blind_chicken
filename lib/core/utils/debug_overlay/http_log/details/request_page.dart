...
class RequestPageState extends State<RequestPage> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemCount: widget.children.length + 3 + (widget.httpInteraction.request?.additionalData != null ? 1 : 0),
