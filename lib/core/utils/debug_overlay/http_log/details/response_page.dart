...
class ResponsePageState extends State<ResponsePage> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemCount: widget.children.length + 2 + (widget.httpInteraction.response?.additionalData != null ? 1 : 0),
