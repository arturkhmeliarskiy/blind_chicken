...
class HttpInteraction {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is HttpInteraction && runtimeType == other.runtimeType && id == other.id;

  @override
  int get hashCode => id.hashCode;

  Duration? get duration => request?.time != null ? responseTime?.difference(request!.time!) : null;
...
class HttpError {
  ...
  bool containsData() => error != null || stackTrace != null || additionalData != null;
