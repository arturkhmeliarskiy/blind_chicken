...
class _HttpLogPageState extends State<HttpLogPage>
            ...
            child: Column(
              children: [
                Expanded(
                  child: Column(
                    children: [
                      const BaseAppBar(title: 'HTTP Details'),
                      HttpLogDetailsPage(
                        entry: entry,
  ...
  Widget _buildMain(BuildContext context, bool split, Iterable<HttpInteraction> interactions) {
    return Column(
      children: [
        if (filterEnabled)
          Padding(
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return HttpLogItem(
          ...
          selected: split && currentEntry != null ? currentEntry == httpInteraction : false,
          onSelected: () {
