...
class MediaQueryInfoEntry extends StatelessWidget {
  ...
  static Future<List<DebugPropertyNode>> _retrieveInfo(BuildContext context) async {
    ...
    return [
      DebugProperty(
        ...
        tooltip: "The size of the media in logical pixels (e.g, the size of the screen).",
      ),
      DebugDoubleProperty(
        "Device Pixel Ratio",
      ...
      DebugProperty(
        ...
        tooltip: "Padding is derived from the values of viewInsets and viewPadding.",
      ),
      DebugProperty(
        "View Insets",
        data.viewInsets,
      ...
      DebugProperty(
        ...
        data.viewPadding,
        defaultValue: EdgeInsets.zero,
        tooltip: 'The parts of the display that are partially obscured by system UI,'
