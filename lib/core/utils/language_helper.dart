...
class LanguageHelper {
  ...
  static final String _defaultLanguage = Env.defaultLanguage;
  ...
  ///Возвращает Language, если язык поддерживается или null, если нет.
  static Language? correlateLanguages(List<Language> languages) {
    String currentLocaleToBackend = getCurrentLocaleToBackend();

    for (var item in languages) {
      if (item.lang == currentLocaleToBackend) {
        return item;
      }
    }
    return null;
