...
class BaseButton extends StatelessWidget {
  ...
  TextStyle _defaultTextStyle(BuildContext context) => AppTextStyles.titleLarge(
        AppColors.white,
      );

  TextStyle _defaultDisabledTextStyle(BuildContext context) => AppTextStyles.titleLarge(
        AppColors.grey43,
      );
