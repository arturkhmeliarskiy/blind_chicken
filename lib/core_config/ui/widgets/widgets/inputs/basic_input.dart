...
class BasicInput extends StatefulWidget {
  ...
  @override
  BasicInputState createState() => BasicInputState();
}
...
class BasicInputState extends State<BasicInput> {
  ...
  @override
  void didUpdateWidget(covariant BasicInput oldWidget) {
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: widget.contentPadding ?? const EdgeInsets.symmetric(vertical: 7, horizontal: 7),
            ),
          ),
