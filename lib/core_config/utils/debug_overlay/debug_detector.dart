  ...
  Widget build(BuildContext context) {
    ...
    return CallbackShortcuts(
      ...
      child: RawGestureDetector(
        gestures: {
          MultiLongPressGestureRecognizer: GestureRecognizerFactoryWithHandlers<MultiLongPressGestureRecognizer>(
            () => MultiLongPressGestureRecognizer(
              duration: delay,
            ...
            (instance) {
              instance.onMultiLongPress = (details) {
                ...
                onDetect!.call();
                context.sendEvent<AppBloc>(const AppEvent.showDebugOverlay(visible: true));
              };
            },
          ),
        },
