  ...
  static Future<List<DebugPropertyNode>> _retrieveInfo() async {
    return [
      ...
      DebugStringProperty(
        ...
        tooltip: "The --packages flag passed to the executable used to run the script in this isolate.",
      ),
      ...
      DebugBlock(
        ...
        properties: Platform.environment.entries.map((entry) => DebugStringProperty(entry.key, entry.value)).toList(),
      ),
