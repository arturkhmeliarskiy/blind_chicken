...
class _$BasketInfoItemResponseImpl extends _BasketInfoItemResponse {
  ...
  @override
  String toString() {
    return 'BasketInfoItemResponse(code: $code, sku: $sku, count: $count, type: $type, identifier: $identifier, sectionCategoriesPath: $sectionCategoriesPath, productCategoriesPath: $productCategoriesPath, titleScreen: $titleScreen, searchQuery: $searchQuery)';
  }
