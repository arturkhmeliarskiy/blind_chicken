...
class CatalogBloc extends Bloc<CatalogEvent, CatalogState> {
  ...
  Future<void> _init(
    ...
    if (Platform.isIOS && pushToken.isEmpty) {
      ...
      logging('push token app bloc: $pushToken', stackTrace: StackTrace.current);
    }
    ...
    if (savePackageInfoVersion.isNotEmpty) {
      ...
      if (packageInfoIOsVersion > savePackageInfoIOsVersion) {
        ...
        logging('Приложение обновлено', stackTrace: StackTrace.current);
      }
    }
    ...
    if (!isAppInstalled) {
      ...
      logging('Приложение установленно', stackTrace: StackTrace.current);
    }
  }
  ...
  Future<void> _getInfoProductsPushNotification(
    ...
    logging(event.filterNotifcation.toString(), stackTrace: StackTrace.current);
