...
class BoutiquesSwitch extends StatefulWidget {
  const BoutiquesSwitch({
    super.key,
  ...
  @override
  State<BoutiquesSwitch> createState() => _BoutiquesSwitchState();
}

class _BoutiquesSwitchState extends State<BoutiquesSwitch> {
  int indexSelect = 0;
