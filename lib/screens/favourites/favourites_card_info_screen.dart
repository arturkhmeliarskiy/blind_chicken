...
class _FavouritesCardInfoScreenState extends State<FavouritesCardInfoScreen> {
  ...
  final BlindChickenShowDialogError _blindChickenFavouritesCardInfoProductShowDialogError =
      BlindChickenShowDialogError();
  final BlindChickenShowDialogError _blindChickenShoppingCartShowDialogError =
      BlindChickenShowDialogError();
  bool _isShowDialogFavouritesCardInfoError = false;
          ...
          productsFavourites: (value) {
            ...
            if (value.isError ?? false) {
              if (!_isShowDialogShoppingCartError &&
                  !_isShowDialogFavouritesCardInfoError &&
                  typeError == 'описание товара') {
                _isShowDialogFavouritesCardInfoError = true;
                _blindChickenFavouritesCardInfoProductShowDialogError.openShowDualog(
                  context: context,
              ...
              if (_isShowDialogFavouritesCardInfoError && !(value.isError ?? false)) {
                _isShowDialogFavouritesCardInfoError = false;
                _blindChickenFavouritesCardInfoProductShowDialogError.closeShowDialog();
              }
        ...
        listener: (context, state) {
          state.maybeMap(
            error: (value) {
              if (!_isShowDialogShoppingCartError &&
                  !_isShowDialogFavouritesCardInfoError &&
                  value.titleScreen == 'Карточка товара в избранном') {
