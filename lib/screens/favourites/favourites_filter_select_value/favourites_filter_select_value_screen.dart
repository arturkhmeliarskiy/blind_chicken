...
@RoutePage()
class FavouritesFilterSelectValueScreen extends StatefulWidget {
  const FavouritesFilterSelectValueScreen({
    super.key,
    required this.index,
    required this.title,
  ...
  @override
  State<FavouritesFilterSelectValueScreen> createState() =>
      _FavouritesFilterSelectValueScreenState();
}
