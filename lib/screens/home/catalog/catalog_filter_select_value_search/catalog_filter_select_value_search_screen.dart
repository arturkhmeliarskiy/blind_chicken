...
@RoutePage()
class CatalogFilterSelectValueSearchScreen extends StatefulWidget {
  const CatalogFilterSelectValueSearchScreen({
    super.key,
    required this.index,
    required this.title,
  ...
  @override
  State<CatalogFilterSelectValueSearchScreen> createState() =>
      _CatalogFilterSelectValueSearchScreenState();
}

class _CatalogFilterSelectValueSearchScreenState
    extends State<CatalogFilterSelectValueSearchScreen> {
              ...
              return state.maybeMap(
                searchProductsResult: (initState) {
                  return BlindChickenFilterButton(
                    ...
                    countProducts: (initState.searchResultInfo?.count ?? 0).toString(),
                  );
                },
                orElse: () => const SizedBox(),
              );
