...
@RoutePage()
class CatalogSearchCardInfoResultScreen extends StatefulWidget {
  const CatalogSearchCardInfoResultScreen({
    super.key,
    required this.item,
  ...
  @override
  State<CatalogSearchCardInfoResultScreen> createState() =>
      _CatalogSearchCardInfoResultScreenState();
}

class _CatalogSearchCardInfoResultScreenState extends State<CatalogSearchCardInfoResultScreen> {
  ...
  @override
  void didUpdateWidget(covariant CatalogSearchCardInfoResultScreen oldWidget) {
    item = widget.item;
        ...
        listener: (context, state) {
          state.maybeMap(
            error: (value) {
              if (!_isShowDialogShoppingCartError &&
                  !_isShowDialogCatalogSearchCardInfoProductError &&
                  value.titleScreen == 'Карточка товара в результате поиска') {
                                                ...
                                                context.read<ShoppingCartBloc>().add(
                                                      ShoppingCartEvent
                                                        ...
                                                        item: BasketInfoItemDataModel(
                                                          ...
                                                          count: 1,
                                                          titleScreen:
                                                              'Карточка товара в результате поиска',
                                                          searchQuery: '',
                                                          typeAddProductToShoppingCart: 'Кнопка',
                                                          identifierAddProductToShoppingCart: '1',
