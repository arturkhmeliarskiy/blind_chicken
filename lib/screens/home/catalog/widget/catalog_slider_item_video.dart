...
class CatalogSliderItemVideo extends StatefulWidget {
  const CatalogSliderItemVideo({
    super.key,
    required this.image,
    required this.video,
  });
...
class _CatalogSliderItemVideoState extends State<CatalogSliderItemVideo> {
