...
class _NewsInfoDescriptionScreenState extends State<NewsInfoDescriptionScreen> {
  ...
  @override
  void initState() {
    context.read<NewsBloc>().add(NewsEvent.updateReadNews(id: widget.info.id, typeNews: 'news'));
              ...
              if (!_isShowDialogNewsInfoError && typeError == 'описание news') {
                ...
                _blindChickenNewsInfoShowDialogError.openShowDualog(
                  ...
                  onRepeatRequest: () {
                    context
                        .read<NewsBloc>()
                        .add(NewsEvent.updateReadNews(id: widget.info.id, typeNews: 'news'));
                  },
                );
              }
            } else {
                            ...
                            HtmlWidget(
                              ...
                              onTapUrl: (url) async {
                                return HandlerLinksNews.handlerLinks(
                                  ...
                                  titleAppMetrica: 'Переход по ссылке из cтраницы описания новости',
