...
@RoutePage()
class ShoppingCartDeliveryInfoScreen extends StatefulWidget {
  const ShoppingCartDeliveryInfoScreen({
    super.key,
    required this.title,
  ...
  @override
  State<ShoppingCartDeliveryInfoScreen> createState() => _ShoppingCartDeliveryInfoScreenState();
}

class _ShoppingCartDeliveryInfoScreenState extends State<ShoppingCartDeliveryInfoScreen> {
