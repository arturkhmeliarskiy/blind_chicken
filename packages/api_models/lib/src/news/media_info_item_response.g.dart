...
_$MediaInfoItemResponseImpl _$$MediaInfoItemResponseImplFromJson(
...
Map<String, dynamic> _$$MediaInfoItemResponseImplToJson(
        _$MediaInfoItemResponseImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
