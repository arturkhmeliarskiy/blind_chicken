...
part of 'media_info_item_data_model.dart';
...
/// @nodoc
mixin _$MediaInfoItemDataModel {
...
/// @nodoc
abstract class $MediaInfoItemDataModelCopyWith<$Res> {
  factory $MediaInfoItemDataModelCopyWith(MediaInfoItemDataModel value,
          $Res Function(MediaInfoItemDataModel) then) =
      _$MediaInfoItemDataModelCopyWithImpl<$Res, MediaInfoItemDataModel>;
  @useResult
  $Res call(
      {String id,
      String title,
...
/// @nodoc
class _$MediaInfoItemDataModelCopyWithImpl<$Res,
        $Val extends MediaInfoItemDataModel>
    implements $MediaInfoItemDataModelCopyWith<$Res> {
  _$MediaInfoItemDataModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$MediaInfoItemDataModelImplCopyWith<$Res>
    implements $MediaInfoItemDataModelCopyWith<$Res> {
  factory _$$MediaInfoItemDataModelImplCopyWith(
          _$MediaInfoItemDataModelImpl value,
          $Res Function(_$MediaInfoItemDataModelImpl) then) =
      __$$MediaInfoItemDataModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$MediaInfoItemDataModelImplCopyWithImpl<$Res>
    extends _$MediaInfoItemDataModelCopyWithImpl<$Res,
        _$MediaInfoItemDataModelImpl>
    implements _$$MediaInfoItemDataModelImplCopyWith<$Res> {
  __$$MediaInfoItemDataModelImplCopyWithImpl(
      _$MediaInfoItemDataModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$MediaInfoItemDataModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$MediaInfoItemDataModelImpl extends _MediaInfoItemDataModel {
  _$MediaInfoItemDataModelImpl(
      {required this.id,
      required this.title,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$MediaInfoItemDataModelImpl &&
  ...
  _$$MediaInfoItemDataModelImplCopyWith<_$MediaInfoItemDataModelImpl>
      get copyWith => __$$MediaInfoItemDataModelImplCopyWithImpl<
          _$MediaInfoItemDataModelImpl>(this, _$identity);
}

abstract class _MediaInfoItemDataModel extends MediaInfoItemDataModel {
  factory _MediaInfoItemDataModel(
