...
part of 'news_info_item_data_model.dart';
...
/// @nodoc
abstract class $NewsInfoItemDataModelCopyWith<$Res> {
  factory $NewsInfoItemDataModelCopyWith(NewsInfoItemDataModel value,
          $Res Function(NewsInfoItemDataModel) then) =
      _$NewsInfoItemDataModelCopyWithImpl<$Res, NewsInfoItemDataModel>;
  @useResult
  $Res call(
      {String id,
      String title,
...
/// @nodoc
class _$NewsInfoItemDataModelCopyWithImpl<$Res,
        $Val extends NewsInfoItemDataModel>
    implements $NewsInfoItemDataModelCopyWith<$Res> {
  _$NewsInfoItemDataModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$NewsInfoItemDataModelImplCopyWith<$Res>
    implements $NewsInfoItemDataModelCopyWith<$Res> {
  factory _$$NewsInfoItemDataModelImplCopyWith(
          _$NewsInfoItemDataModelImpl value,
          $Res Function(_$NewsInfoItemDataModelImpl) then) =
      __$$NewsInfoItemDataModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$NewsInfoItemDataModelImplCopyWithImpl<$Res>
    extends _$NewsInfoItemDataModelCopyWithImpl<$Res,
        _$NewsInfoItemDataModelImpl>
    implements _$$NewsInfoItemDataModelImplCopyWith<$Res> {
  __$$NewsInfoItemDataModelImplCopyWithImpl(_$NewsInfoItemDataModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$NewsInfoItemDataModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$NewsInfoItemDataModelImpl extends _NewsInfoItemDataModel {
  _$NewsInfoItemDataModelImpl(
      {required this.id,
      required this.title,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$NewsInfoItemDataModelImpl &&
  ...
  _$$NewsInfoItemDataModelImplCopyWith<_$NewsInfoItemDataModelImpl>
      get copyWith => __$$NewsInfoItemDataModelImplCopyWithImpl<
          _$NewsInfoItemDataModelImpl>(this, _$identity);
}

abstract class _NewsInfoItemDataModel extends NewsInfoItemDataModel {
  factory _NewsInfoItemDataModel(
